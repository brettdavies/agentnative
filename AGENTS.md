...
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `~/dev/agentnative-cli` (`brettdavies/agentnative-cli`)     | Rust `anc` linter, 46-entry principle registry, scorecard emitter                                                                                   | Consumes this repo's `VERSION` + principle IDs. Coupled-release norm links spec PRs to checker PRs.                                                                                                              |
